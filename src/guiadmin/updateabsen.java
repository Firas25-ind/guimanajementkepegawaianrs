 ...
 * @author insan
 */
public class updateabsen extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tidakhadir.setBounds(634, 597, 115, 29);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(updateabsen.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new updateabsen().setVisible(true);
            }
        });
    }
