 ...
 * @author insan
 */
public class pertimbanganpengajuancuti extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Nama", "ID", "Tanggal Pengajuan", "Jenis Cuti", "Tanggal Mulai", "Tanggal Selesai", "Alasan"
            }
        ));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(pertimbanganpengajuancuti.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new pertimbanganpengajuancuti().setVisible(true);
            }
        });
    }
