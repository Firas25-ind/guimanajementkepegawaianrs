 ...
 * @author insan
 */
public class chekinabsen extends javax.swing.JFrame {

    /**
     * Creates new form chekinabsen
     */
    public chekinabsen() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Nama", "ID", "Tanggal", "Jam Mulai", "Jam Selesai", "Status"
            }
        ));
        ...
        kembali1.setBounds(0, 0, 99, 29);

        kembali2.setFont(new java.awt.Font("Tahoma", 1, 16)); // NOI18N
        ...
        getContentPane().add(kembali2);
        kembali2.setBounds(1070, 560, 99, 40);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(chekinabsen.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new chekinabsen().setVisible(true);
            }
        });
    }
